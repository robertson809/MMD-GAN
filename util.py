...
def get_args(parser):
    ...
    parser.add_argument('--input_size', required=True, type=int, default=6, help='the size of the input vector')
    parser.add_argument('--initial_layer_size', type=int, default=64, help='layers in the linear feed forward')
    parser.add_argument('--hidden_dim', type=int, default=10, help='size of the latent z vector')
